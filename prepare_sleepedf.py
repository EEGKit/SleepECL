...
def main():
    ...
    for i in range(len(psg_fnames)):
        ...
        print("Loading ...")
        print("Signal file: {}".format(psg_fnames[i]))
        print("Annotation file: {}".format(ann_fnames[i]))
        ...
        print("Start datetime: {}".format(str(start_datetime)))

        file_duration = psg_f.getFileDuration()
        print("File duration: {} sec".format(file_duration))
        ...
        if psg_f.datarecord_duration == 60: # Fix problems of SC4362F0-PSG.edf, SC4362FC-Hypnogram.edf
            ...
            print("Epoch duration: {} sec (changed from 60 sec)".format(epoch_duration))
        else:
            print("Epoch duration: {} sec".format(epoch_duration))
        ...
        print("Select channel: {}".format(select_ch))
        print("Select channel samples: {}".format(ch_samples[select_ch_idx]))
